...
| V2c (`courier_request_items`) | `courier_request_items` | inventory → courier | Not yet fixed — out of Phase 5's scope (identity/inventory/accounting boundaries only); planned for Phase 5B | Pending |
