 ...
 *
 * Proves the shared test utilities (createTestApp, createAuthenticatedRequest,
 * createUnauthenticatedRequest, fixtures) actually work end-to-end against a
 * real, unmodified route module (leads-audit.routes.ts — chosen because the
 * coverage audit found it has ZERO existing tests and its handlers do not
 * require a database, making it a clean target for a DB-free HTTP smoke).
 *
...
import { registerLeadDiscoveryAuditRoutes } from "../../../modules/leads/leads-audit.routes";
