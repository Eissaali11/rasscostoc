...
import { CourierWorkflow } from "./courier.workflow";
...
import { InventorySubscriber } from "../../../inventory/infrastructure/subscribers/inventory.subscriber";
import { CourierAuditSubscriber } from "../../../courier/infrastructure/subscribers/courier-audit.subscriber";
import { CourierSagaSubscriber } from "../../../courier/infrastructure/subscribers/courier-saga.subscriber";
...
vi.mock("../inventory/inventory.engine", () => {
  return {
    InventoryEngine: {
      createDefault: () => ({
        deduct: mockDeduct,
