...
export class SerializedItemsController {
  ...
  scanIn = asyncHandler(async (req: Request, res: Response) => {
    ...
    const item = await serializedItemsService.scanIn(
      user.id,
      body.serialNumber,
      body.itemTypeId,
      body.carrierName,
  ...
  scanOut = asyncHandler(async (req: Request, res: Response) => {
    ...
    const item = await serializedItemsService.scanOut(
      user.id,
      body.serialNumber,
      body.receiverName,
      body.orderNumber,
  ...
  lookup = asyncHandler(async (req: Request, res: Response) => {
    ...
    const item = await serializedItemsService.lookup(serialNumber);
...
export const serializedItemsController = new SerializedItemsController();
